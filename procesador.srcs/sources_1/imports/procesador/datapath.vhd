...
BEGIN
    ...
    PORT MAP(
        INSTRUCTION(INSTRUCTION_LENGTH - 1 DOWNTO INSTRUCTION_LENGTH - 5), Z, RST, CLK,
        PC_ENABLE, PC_WE, REG_WE, REG_I_DATA_SEL, ALU_OPE, MEM_DATA_WE, ALU_I_DATA_SEL, MEM_DIR_SEL);
