...
ARCHITECTURE Behavioral OF DATAPATH IS
    ...
    SIGNAL INST_DIR : STD_LOGIC_VECTOR (MEM_PROG_DIR_LENGTH - 1 DOWNTO 0);
    -- Memory data (RAM)
    ...
    SIGNAL P_INST_DIR : STD_LOGIC_VECTOR (MEM_PROG_DIR_LENGTH - 1 DOWNTO 0);
    SIGNAL P_ID_PC_DIR : STD_LOGIC_VECTOR (MEM_PROG_DIR_LENGTH - 1 DOWNTO 0);
    SIGNAL P_ID_MEM_DIR_INST : STD_LOGIC_VECTOR (MEM_DATA_DIR_LENGTH - 1 DOWNTO 0);
    -- Pipeline EX
...
BEGIN
    ...
    -- Pipeline ID - MEM_DIR_INST
    P_ID_MEM_DIR_INST_R : REGISTRO GENERIC MAP(MEM_DATA_DIR_LENGTH)
    PORT MAP(INSTRUCTION(INSTRUCTION_LENGTH - 21 DOWNTO INSTRUCTION_LENGTH - 30), CLK, RST, '1', P_ID_MEM_DIR_INST);
    
    -- Pipeline EX - MEM_DIR_INST
    P_EX_MEM_DIR_INST_R : REGISTRO GENERIC MAP(MEM_DATA_DIR_LENGTH)
    PORT MAP(P_ID_MEM_DIR_INST, CLK, RST, '1', MEM_DIR_INST);
    ...
    -- Pipeline dir instruction
    P_INST_DIR <= INSTRUCTION(INSTRUCTION_LENGTH - 21 DOWNTO INSTRUCTION_LENGTH - 30);
    P_INST_DIR_R : REGISTRO GENERIC MAP(MEM_PROG_DIR_LENGTH)
    PORT MAP(P_INST_DIR, CLK, RST, '1', INST_DIR);
    ...
    PORT MAP(PC_DIR, INST_DIR, "000", P_EX_PC_DIR_ALU);
    ...
    -- Pipeline REG
    P_REG_R1 : REGISTRO GENERIC MAP(WORD_LENGTH)
    PORT MAP(P_REG_O_DATA_R1, CLK, RST, '1', REG_O_DATA_R1);
    P_REG_R2 : REGISTRO GENERIC MAP(WORD_LENGTH)
