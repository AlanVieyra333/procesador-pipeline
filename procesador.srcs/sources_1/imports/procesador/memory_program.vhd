...
BEGIN
    -- Programa de muestra punto flotante.
    DATA <= (
        "00000" & "00000" & "0"&"10000101"&"00000100000000000000000", -- LWI R0, #65.0
        "00000" & "00001" & "0"&"10000001"&"11000000000000000000000", -- LWI R1, #7.0
        "00000" & "00010" & x"0000000f", -- LWI R2, #15
        "00000" & "00011" & x"00000007", -- LWI R3, #7
        (OTHERS => '1'), -- NOP
        "01111" & "00100" & "00000" & "00001" & x"FFFFF" & "11", -- ADDF R4, R0, R1
        "10000" & "00101" & "00000" & "00001" & x"FFFFF" & "11", -- SUBF R5, R0, R1
        "10001" & "00110" & "00000" & "00001" & x"FFFFF" & "11", -- MULF R6, R0, R1
        
        "00011" & "00111" & "00010" & "00011" & x"FFFFF" & "11", -- ADD R7, R2, R3
        "00100" & "01000" & "00010" & "00011" & x"FFFFF" & "11", -- SUB R8, R2, R3
        (OTHERS => '1'), -- NOP
        (OTHERS => '1'), -- NOP
        (OTHERS => '1'), -- NOP
        -- LOOP:
        "01011" & "11111" & "11111" & "11111" & "0000000000" & x"FFF", -- B -0     // goto LOOP
        OTHERS => (OTHERS => '1'));
...
--        "01011" & "11111" & "11111" & "11111" & "0000010101" & x"FFF", -- B +21     // goto ELSE-2
--        (OTHERS => '1'), -- NOP
--        (OTHERS => '1'), -- NOP
--        (OTHERS => '1'), -- NOP
--        -- ELSE-1:
...
--        -- ELSE-2:
--        "01010" & "11111" & "00011" & "00101" & "1111110111" & x"FFF", -- BNEI R3, R5, -9 // goto CONTINUE
--        (OTHERS => '1'), -- NOP
--        (OTHERS => '1'), -- NOP
--        (OTHERS => '1'), -- NOP
--        "01011" & "11111" & "11111" & "11111" & "1111011110" & x"FFF", -- B -34     // goto MAIN
--        OTHERS => (OTHERS => '1'));
