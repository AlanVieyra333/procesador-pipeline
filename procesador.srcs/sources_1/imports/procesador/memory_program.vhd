...
BEGIN
    -- Programa de prueba !.
    DATA <= (
        "00001" & "00001" & "00000" & "XXXXX" & "00" & x"03" & x"FFF",   -- LW R1, 3(R0)
        "00001" & "00010" & "00000" & "XXXXX" & "00" & x"04" & x"FFF",   -- LW R2, 4(R0)
        "00001" & "00011" & "00000" & "XXXXX" & "00" & x"05" & x"FFF",   -- LW R3, 5(R0)
        (OTHERS => '1'), -- NOP
        "01001" & "00001" & "00001" & x"FFFFFF" & "111", -- INC R1, R1
        "01010" & "XXXXX" & "00001" & "00001" & "1111101001" & x"FFF", -- BNEI R1, R1, -5 //0 (DIR-2)
        ...
        "01011" & "XXXXX" & "00001" & "00000" & "0000000110" & x"FFF", -- B +6
        ...
        (OTHERS => '1'), -- STALL
        (OTHERS => '1'), -- STALL
        "00010" & "XXXXXXXXXX" & "0" & x"4" & "0000000011" & x"FFF", -- SWI R4, 3
        "00010" & "XXXXXXXXXX" & "0" & x"5" & "0000000100" & x"FFF", -- SWI R5, 4
        "00010" & "XXXXXXXXXX" & "0" & x"6" & "0000000101" & x"FFF", -- SWI R6, 5
        "00010" & "XXXXXXXXXX" & "0" & x"7" & "0000000110" & x"FFF", -- SWI R7, 6
        "00010" & "XXXXXXXXXX" & "0" & x"8" & "0000000111" & x"FFF", -- SWI R8, 7
        OTHERS => (OTHERS => '1'));
