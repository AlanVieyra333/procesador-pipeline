...
BEGIN
    ...
    DATA <= (
        "00000" & "00000" & x"00001010", -- LWI R0, #10
        ...
        (OTHERS => '1'), -- NOP
        -- ELSE-1:
        "01000" & "11111" & "00011" & "00011" & "1000000000", -- SW R3, 512(R3)  | Mem[R3 + 10] = R3
        "01000" & "11111" & "00011" & "00000" & "0000000000", -- SW R0, 0(R3)    | Mem[R3 + 0] = R0
        ...
        -- ELSE-2:
        "00100" & "00100" & "00100" & "00010" & x"FFFFF" & "11", -- SUB R4, R4, R2
        (OTHERS => '1'), -- NOP
        (OTHERS => '1'), -- NOP
        (OTHERS => '1'), -- NOP
        "01010" & "11111" & "00100" & "00101" & "1111110111" & x"FFF", -- BNEI R4, R5, -9 // goto CONTINUE
        (OTHERS => '1'), -- NOP
        (OTHERS => '1'), -- NOP
        (OTHERS => '1'), -- NOP
